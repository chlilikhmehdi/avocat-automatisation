...
export default function LawyerDashboard({ currentUser }) {
  ...
  useEffect(() => {
    ...
    const fetchCases = async () => {
      ...
      setError('');
      try {
        const res = await getCases(currentUser.id, {
          search,
          status: statusFilter,
          page,
          limit: 10,
        ...
        {[
          ...
          <div key={s.label} style={{
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: '#64748b', marginTop: 3, textTransform: 'uppercase', letterSpacing: '.5px' }}>
                {s.label}
              </div>
            </div>
          </div>
        ...
        {pagination.pages > 1 && (
          <div style={{
            ...
            <span style={{ fontSize: 13, color: '#64748b' }}>
              {pagination.total} dossier(s) · Page {page} sur {pagination.pages}
            </span>
